...
def main():
    st.set_page_config(
        page_title = "Implementação MongoDB - Rent Right",
        layout = "wide",
        menu_items = {
    ...
    Aqui você pode visualizar estatísticas sobre o banco de dados Housing implementado em MongoDB algumas das funções disponíveis nesse dashboard incluem
...
# __Todo__!   Antes tinha uma função "Create_schema()" que criava e iniciava um DB, caso seja necessário, implementar aqui